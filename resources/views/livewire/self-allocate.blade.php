            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    @if ($data)
                        ...
                        @if ($allocated)
                            <h5 class="text-muted text-center"><i class="mdi mdi-chart-gantt"></i> My Allocation Details
                            </h5>
                            ...
                            <button class="btn btn-outline-primary w-100" wire:click="movetoUpdate"><i
                                    class="mdi mdi-account-edit"></i> Update Details</button>
                        @elseif ($gotoUpdate)
                            <form action="" wire:submit.prevent="updateAllocation" enctype="multipart/form-data"
                                method="POST">
                                @csrf
                                <span class=""> <i class="mdi mdi-pencil"></i> Update Details of your Field
                                    Area!</span>
                                <div class="row mb-3 mt-3">
                                    <div class="col-md-6 mb-2">
                                        <label for="" class="text-muted mb-2">Company Name<span
                                                class="text-muted"><span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="" class="text-muted mb-2">Department Name<span
                                                class="text-muted"><span class="text-danger">*</span></label>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6 mb-2">
                                        <label for="" class="text-muted mb-2">Upload Signed Welcome Letter <span
                                                class="text-danger">* </span> </label>
                                        <input type="file" class="form-control" wire:model="letter" id=""
                                    ...
                                    <div class="col-md-6">
                                        <label for="" class="text-muted mb-2">Region<span
                                                class="text-muted"><span class="text-danger">*</span></label>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label for="" class="text-muted mb-2">Ward<span
                                                class="text-muted"><span class="text-danger">*</span></label>
                                ...
                                <div class="row justify-content-center mb-3 mt-4 px-3">
                                    <button class="btn btn-outline-primary" type="submit"><i
                                            class="mdi mdi-clear"></i> Upadate Now</button>
                                </div>

                            </form>
                        @endif
                    @else
                        <form action="" wire:submit.prevent="selfAllocate" enctype="multipart/form-data"
                            method="POST">
                            @csrf
                            <span class=""><span class="text-danger">*</span class="fw-bold"> Provide the
                                Details of your Field Area!</span>
                            <div class="row mb-3 mt-3">
                                <div class="col-md-6 mb-2">
                                    <label for="" class="text-muted mb-2">Company Name<span
                                            class="text-muted"><span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" wire:model="company" id=""
                                        aria-describedby="helpId" placeholder="Enter Company name...">
                                    <small class="text-danger">
                                        @error('company')
                                            {{ $message }}
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="" class="text-muted mb-2">Ward<span class="text-muted"><span
                                                class="text-danger">*</span></label>
                                    <select id="smallSelect" wire:model="ward" class="form-select">
                                        <option value="">Select Ward..</option>
                                        @if (!is_null($district))
